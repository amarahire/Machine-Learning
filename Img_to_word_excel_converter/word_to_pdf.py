...
def openFile(): 
    ...
    file = askopenfilename(defaultextension=".docx", 
...
def convertfile():
    try:
        ...
        convert(file,r"F:\projects\Img_to_word_excel_converter\word_to_pdf.pdf")
        ...
        fileEntry.insert(0,"Please select a word file first")
    except:
        pass
...
root.title("WORD FILE CONVERTER [designed by:CHETAN SHARMA]")
root.resizable(0,0)
try:
...
#==============App Name==============================================================>>
appName = Label(root,text="Word To PDF Converter",font=('arial',20,'bold'),
